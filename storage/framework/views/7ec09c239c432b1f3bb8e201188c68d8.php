<div class="py-10">
    <div class="container mx-auto px-4">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button wire:click="$set('categoryId', <?php echo e($cat->category_id); ?>)"
                            wire:key="cat-<?php echo e($cat->category_id); ?>"
                            wire:loading.attr="disabled"
                            class="px-6 py-2.5 rounded-xl text-sm font-bold transition-all disabled:opacity-50
        ...
        <p class="text-sm text-gray-500 mb-6">
            Showing <span class="font-semibold text-gray-900 dark:text-white"><?php echo e($courses->count()); ?></span> courses
        </p>
...
</div><?php /**PATH D:\Internship_ASS\Laravel\learnhub_project\resources\views/livewire/courses-page.blade.php ENDPATH**/ ?>