<footer
    ...
    <div class="container mx-auto px-4 py-16">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li><a href="<?php echo e(route('home')); ?>" class="hover:text-purple-400 transition-colors">Home</a></li>
                    <li><a href="<?php echo e(route('courses')); ?>" class="hover:text-purple-400 transition-colors">Courses</a>
                    </li>
                    <li><a href="<?php echo e(route('documents')); ?>" class="hover:text-purple-400 transition-colors">Documents</a>
                    </li>
                    <li><a href="<?php echo e(route('about')); ?>" class="hover:text-purple-400 transition-colors">About</a></li>
                    <li><a href="<?php echo e(route('contact')); ?>" class="hover:text-purple-400 transition-colors">Contact</a>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li><a href="<?php echo e(route('contact')); ?>" class="hover:text-purple-400 transition-colors">Help Center</a>
                    </li>
        ...
        <div class="border-t border-gray-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p class="text-sm">© <?php echo e(date('Y')); ?> LearnHub. All rights reserved.</p>
...
</footer><?php /**PATH D:\Internship_ASS\Laravel\learnhub_project\resources\views/livewire/partials/footer.blade.php ENDPATH**/ ?>