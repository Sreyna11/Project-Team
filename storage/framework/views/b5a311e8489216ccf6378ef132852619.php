<?php $__env->startSection('title', 'About LearnHub'); ?>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [
                            ...
                            <div class="bg-purple-50 dark:bg-purple-900/20 rounded-2xl p-5">
                                <div class="text-3xl font-black text-purple-600 mb-1"><?php echo e($stat['number']); ?></div>
                                <div class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($stat['label']); ?></div>
                            </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow">
                            <div class="w-12 h-12 rounded-xl bg-<?php echo e($val['color']); ?>-50 dark:bg-<?php echo e($val['color']); ?>-900/30 flex items-center justify-center mb-4">
                                <i class="fas <?php echo e($val['icon']); ?> text-<?php echo e($val['color']); ?>-600 text-xl"></i>
                            </div>
                            <h3 class="font-black text-base text-gray-900 dark:text-white mb-2"><?php echo e($val['title']); ?></h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400 leading-relaxed"><?php echo e($val['desc']); ?></p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-3xl p-8 border border-gray-100 dark:border-gray-700 text-center hover:shadow-xl transition-shadow">
                        <div class="w-16 h-16 rounded-2xl bg-purple-50 dark:bg-purple-900/30 flex items-center justify-center mx-auto mb-6">
                            <i class="fas <?php echo e($reason['icon']); ?> text-purple-600 text-2xl"></i>
                        </div>
                        <h3 class="font-black text-xl text-gray-900 dark:text-white mb-4"><?php echo e($reason['title']); ?></h3>
                        <p class="text-gray-500 dark:text-gray-400 text-sm leading-relaxed"><?php echo e($reason['desc']); ?></p>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Internship_ASS\Laravel\learnhub_project\resources\views/pages/about.blade.php ENDPATH**/ ?>