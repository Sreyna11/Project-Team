    ...
    <div class="container mx-auto px-4">
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden items-center gap-6 md:flex">
                <a href="<?php echo e(route('home')); ?>" class="text-sm font-medium text-gray-700 hover:text-purple-600 transition-colors nav-link">Home</a>
                <a href="<?php echo e(route('about')); ?>" class="text-sm font-medium text-gray-700 hover:text-purple-600 transition-colors nav-link">About</a>
                <a href="<?php echo e(route('courses')); ?>" class="text-sm font-medium text-gray-700 hover:text-purple-600 transition-colors nav-link">Courses</a>
                <a href="<?php echo e(route('documents')); ?>" class="text-sm font-medium text-gray-700 hover:text-purple-600 transition-colors nav-link">Documents</a>
                <a href="<?php echo e(route('contact')); ?>" class="text-sm font-medium text-gray-700 hover:text-purple-600 transition-colors nav-link">Contact</a>
            </div>
        ...
        <div id="mobile-menu" class="hidden border-t border-gray-200 py-4 md:hidden">
            <div class="flex flex-col gap-3">
                <a href="<?php echo e(route('home')); ?>" class="font-medium text-gray-700 hover:text-purple-600 py-2 px-4 rounded-lg hover:bg-gray-50" onclick="closeMobileMenu()">Home</a>
                <a href="<?php echo e(route('about')); ?>" class="font-medium text-gray-700 hover:text-purple-600 py-2 px-4 rounded-lg hover:bg-gray-50" onclick="closeMobileMenu()">About</a>
                <a href="<?php echo e(route('courses')); ?>" class="font-medium text-gray-700 hover:text-purple-600 py-2 px-4 rounded-lg hover:bg-gray-50" onclick="closeMobileMenu()">Courses</a>
                <a href="<?php echo e(route('documents')); ?>" class="font-medium text-gray-700 hover:text-purple-600 py-2 px-4 rounded-lg hover:bg-gray-50" onclick="closeMobileMenu()">Documents</a>
                <a href="<?php echo e(route('contact')); ?>" class="font-medium text-gray-700 hover:text-purple-600 py-2 px-4 rounded-lg hover:bg-gray-50" onclick="closeMobileMenu()">Contact</a>
...
<?php /**PATH D:\Internship_ASS\Laravel\learnhub_project\resources\views/partials/navbar.blade.php ENDPATH**/ ?>